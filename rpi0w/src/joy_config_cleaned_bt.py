...
def callback(data):
	...
	if data.buttons[12] == 1:
		...
		if data.buttons[12] == 1: # and num<=numturns:
			j = 0
			while data.buttons[12] == 1 and data.buttons[12] != 0 and j<=21:
				rospy.sleep(ts)
	...
	if data.buttons[14] == 1:
		...
		if data.buttons[14] == 1: # and num<=numturns:
			j = 0
			while data.buttons[14] == 1 and data.buttons[14] != 0 and j <=21:
				rospy.sleep(ts)
	...
	if data.buttons[13] == 1:
		...
		if data.buttons[13] == 1: # and num<=numturns:
			j = 0
			while data.buttons[13] == 1 and data.buttons[13] != 0 and j<=21:
				rospy.sleep(ts)
	...
	if data.buttons[15] == 1:
		...
		if data.buttons[15] == 1: # and num<=numturns:
			j = 0
			#while data.buttons[3] == 1 and j<=21:
			while j in range(0,22) and data.buttons[15] == 1 and data.buttons[15] != 0:
				rospy.sleep(ts)
	...
	if data.buttons[10] == 1:
		...
		if data.buttons[10] == 1: # and num<=numturns:
			j = 0
			while data.buttons[10] == 1 and data.buttons[10] != 0 and j<=21:
				rospy.sleep(ts)
	...
	if data.buttons[11] == 1:
		...
		if data.buttons[11] == 1: # and num<=numturns:
			j = 0
			while data.buttons[11] == 1 and data.buttons[11] != 0 and j<=21:
				rospy.sleep(ts)
	...
	# increment stance angle for knee (i.e. raise height of body in stance)
	while data.buttons[4] == 1 and kneestance > 10 and kneestance < 50:
		kneestance += 5
		rospy.sleep(0.1)

	# decrement stance angle for knee (i.e. lower height of body in stance)
	while data.buttons[6] == 1 and kneestance > 10 and kneestance < 50:
		kneestance += (-5)
		rospy.sleep(0.1)

	# reset to specified stance
	if data.buttons[3] == 1:
		while data.buttons[3] == 1 and data.buttons[3] != 0:
			rospy.sleep(ts)
